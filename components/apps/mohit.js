...
export class AboutMohit extends Component {
  constructor() {
    super();
    this.screens = {};
    this.state = {
...
export default AboutMohit;

export const displayAboutMohit = () => {
  return <AboutMohit />;
};
    ...
    <>
      <div className="w-20 md:w-28 my-4 bg-white rounded-full">
        <img
          ...
          alt="Mohit Kumar Logo"
        />
      </div>
      <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
        <div>
          my name is <span className="font-bold">Mohit Kumar</span> ,
        </div>
      ...
      <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
        <li className=" list-pc">
          I'm a 20 year old{" "}
          <span className=" font-medium">Under Graduate Student</span> finishing
          up my 3rd year of bachelore's in Computer Science at GLA University.
          Derivable from my degree, I have a passion for tech.
        </li>
        <li className=" mt-3 list-building">
          {" "}
          I thoroughly enjoy boxing, long distance running (masochism?!)
        </li>
        <li className=" mt-3 list-time">
          {" "}
          When I am not coding my next project, I like to spend my time writing
          and reading about aviation.
        </li>
      ...
      <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
        ...
        <li className="list-disc">
          <div className=" text-lg md:text-xl mt-4 text-left font-bold leading-tight">
            Delhi Public School, MRN - DPS MRN
          </div>
  ...
  const project_list = [
    {
      ...
      date: "Apr 2025",
      link: "https://github.com/Mohit-005/Mohit-005.github.io",
      description: [
    ...
    },
    {
      name: "Weather App",
      date: "Dec 2022",
      link: "https://github.com/Mohit-005/Weather-App",
      description: [
        "Weather App: Built the front-end of a weather app using Vue2 and Axios",
      ],
      domains: ["Vanilla Frontend", "Axios", "Vue2"],
    },
    {
      name: "WhatsApp Automater",
      date: "Apr 2023",
      link: "https://github.com/Mohit-005/Automate-WhatsApp",
      description: [
        "WhatsApp Automater: Built a tool to send bulk WhatsApp messages for marketing without any API for free.",
      ],
      domains: ["python", "selenium"],
    },
    {
      name: "Eyewear Store",
      date: "Jul 2024",
      link: "https://glass-county-react.vercel.app/",
      description: [
        "E-commerce Web Application: Built a fully responsive eyewear e-commerce platform using ReactJS and Tailwind CSS.",
      ],
      domains: ["javascript", "reactjs", "tailwindcss"],
    },
    {
      name: "CRM",
      date: "Sept 2024",
      link: "https://dannys-crm.herokuapp.com/",
      description: [
        "Customer Relationship Software: Built a fully functional CRM Software using ReactJS, NodeJS and MongoDB",
      ],
      domains: ["javascript", "reactjs", "tailwindcss"],
    },
    {
      ...
      date: "May 2023",
      link: "https://githubgraphpainter.vercel.app/",
      description: [
        "GitHub Graph Painter: Creates a custom design for your GitHub Commit Contribution Graph",
      ],
      domains: ["Nodejs", "javascript"],
    },
    {
      name: "LeetCode Auto-Solver",
      date: "Apr 2024",
      link: "https://mohit-005.github.io/Leetcode-Plus/",
      description: [
        "Automated Leetcode Solver: Built a bot to fetch, solve and submit Leetcode problems programatically.",
      ],
      domains: ["python", "selenium"],
    },
    // {
    ...
    //   date: "Nov 2020",
    //   link: "https://github.com/Mohit-005/Meditech-Healthcare",
    //   description: [
    ...
    //   date: "Sep 2020",
    //   link: "https://github.com/Mohit-005/Improve-Codeforces",
    //   description: [
    ...
    //   date: "Dec 2019",
    //   link: "https://github.com/Mohit-005/CPU-Scheduling-APP-React-Native",
    //   description: [
            ...
            <div className="w-full py-1 px-2 my-2 border border-gray-50 border-opacity-10 rounded hover:bg-gray-50 hover:bg-opacity-5 cursor-pointer">
              <div className="flex flex-wrap justify-between items-center">
                <div className="flex justify-center items-center">
                  ...
                  <iframe
                    src={`https://ghbtns.com/github-btn.html?user=Mohit-005&repo=${projectName}&type=star&count=true`}
                    frameBorder="0"
                    scrolling="0"
                    width="150"
                    height="20"
...
function Resume() {
  return (
    <iframe
      ...
      src="./files/Mohit-Kumar-Resume.pdf"
      title="mohit kumar resume"
      frameBorder="0"
    ></iframe>
  );
}
